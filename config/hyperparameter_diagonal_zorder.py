class Path_Hyperparameter:
    random_seed = 42
    # ming
    scan_types=['diagonal', 'zorder']
    scan_type='diagonal_zorder'
    model_name='MDA-RSM'
    per_scan_num=4
    ...
    save_interval: int = 100  # save checkpoint every interval epoch
    ...
    log_wandb_project: str = f'{model_name}_{batch_size}_{per_scan_num}_{scan_type}'  # wandb project name
